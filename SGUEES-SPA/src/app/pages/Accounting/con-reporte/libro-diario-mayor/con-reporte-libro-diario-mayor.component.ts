...
@Component({
	selector: 'app-con-reporte-libro-diario-mayor',
	templateUrl: '../con-reporte.component.html',
})
export class ConReporteLibroDiarioMayorComponent extends ConReporteComponent {
	protected readonly configUi: ConReporteUiConfig = {
		...
		filtroInicial: { partidaCierreLiquidacionMayor: true },
	};
