...
export class ConClasePartidaService {
	...
	getItems(): any {
		return [
			...
			{ itemType: 'empty', colSpan: 4 },
			{
				dataField: 'CORR_LINEA_AUMENTA',
				label: { text: 'Línea Aumenta' },
				colSpan: 4,
				template: 'CORR_LINEA_AUMENTALookup',
			},
			{ itemType: 'empty', colSpan: 4 },
			{
				dataField: 'CORR_LINEA_DISMINUYE',
				label: { text: 'Línea Disminuye' },
				colSpan: 4,
				template: 'CORR_LINEA_DISMINUYELookup',
			},
			{ itemType: 'empty', colSpan: 4 },
