...
export class ScDescriptorPuestoRequerimientoOrganizacionalRepository {
	...
	// Consulta los requerimientos vinculados al descriptor; la selección de catálogo
	// se convierte en payload en la capa de servicio.
	...
	// La llave del vínculo se envía como condición para no modificar el catálogo de origen.
