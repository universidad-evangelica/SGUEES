...
export class ScDescriptorRiesgoPuestoComponent extends CBaseComponent implements OnInit {
	...
	constructor(public override appInfoService: AppInfoService, public override router: ActivatedRoute, private service: ScDescriptorRiesgoPuestoService, private messageService: MessageService) {
