		...
		return [
			{
				...
				buttons: [
					...
					{ hint: 'Activar registro', icon: 'check', stylingMode: 'text', cssClass: 'sguees-grid-action-edit', visible: (event: any) => !event.row?.data?.ESTADO_RIESGO_PUESTO, onClick: onActivarClick },
