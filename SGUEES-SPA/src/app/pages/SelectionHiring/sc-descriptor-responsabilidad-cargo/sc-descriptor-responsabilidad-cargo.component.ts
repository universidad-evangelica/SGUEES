...
export class ScDescriptorResponsabilidadCargoComponent extends CBaseComponent implements OnInit {
	...
	constructor(public override appInfoService: AppInfoService, public override router: ActivatedRoute, private service: ScDescriptorResponsabilidadCargoService) {
