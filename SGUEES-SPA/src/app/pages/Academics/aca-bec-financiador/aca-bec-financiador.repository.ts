...
export class AcaBecFinanciadorRepository {
	readonly xController = 'ACA_BEC_FINANCIADOR';
	...
	getEntidadesFinanciadoras(): Observable<IResult> {
		return this.objData.Get(this.xController, 'EntidadesFinanciadoras', [], environment.UrlGENERALAPI);
	}
