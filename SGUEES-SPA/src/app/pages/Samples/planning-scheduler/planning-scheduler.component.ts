...
import { DataService, ScreenService } from 'src/app/shared/services';
import { CalendarListModule } from 'src/app/shared/components/utils/calendar-list/calendar-list.component';
import { LeftSidePanelModule } from 'src/app/shared/components/utils/left-side-panel/left-side-panel.component';
import { RightSidePanelModule } from 'src/app/shared/components/utils/right-side-panel/right-side-panel.component';
import { AgendaItem, AgendaModule } from "src/app/shared/components/utils/agenda/agenda.component";
import { ApplyPipeModule } from '../../../pipes/apply.pipe';
import { SchedulerTooltipModule } from 'src/app/shared/components/library/scheduler-tooltip/scheduler-tooltip.component';
