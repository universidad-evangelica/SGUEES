// Qué hace: acceso HTTP al API de Religión.
// Cómo lo hace: llama al controller GEN_RELIGION vía CData (GENERAL API).
...
export class GenReligionRepository {
	readonly xController = 'GEN_RELIGION';
