...
export class GenEstructuraTerritorialRepository {
	...
	// Consulta el listado de países mediante el endpoint territorial.
	...
	// Envía al API la solicitud para eliminar el país indicado.
