// Qué hace: acceso HTTP al API de Tipo Contribuyente.
// Cómo lo hace: llama al controller GEN_TIPO_CONTRIBUYENTE vía CData (GENERAL API).
...
export class GenTipoContribuyenteRepository {
	readonly xController = 'GEN_TIPO_CONTRIBUYENTE';
