// Qué hace: acceso HTTP al API de Parentesco.
// Cómo lo hace: llama al controller GEN_PARENTESCO vía CData (GENERAL API).
...
export class GenParentescoRepository {
	readonly xController = 'GEN_PARENTESCO';
