// Qué hace: acceso HTTP al API de Tipo Contacto.
// Cómo lo hace: llama al controller GEN_TIPO_CONTACTO vía CData (GENERAL API).
...
export class GenTipoContactoRepository {
	readonly xController = 'GEN_TIPO_CONTACTO';
