// Qué hace: acceso HTTP al API de Actividad Económica.
// Cómo lo hace: llama al controller GEN_ACTIVIDAD_ECONOMICA vía CData (GENERAL API).
...
export class GenActividadEconomicaRepository {
	readonly xController = 'GEN_ACTIVIDAD_ECONOMICA';
