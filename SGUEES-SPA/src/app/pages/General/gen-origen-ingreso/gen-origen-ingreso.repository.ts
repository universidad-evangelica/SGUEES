// Qué hace: acceso HTTP al API de Origen Ingreso.
// Cómo lo hace: llama al controller GEN_ORIGEN_INGRESO vía CData (GENERAL API).
...
export class GenOrigenIngresoRepository {
	readonly xController = 'GEN_ORIGEN_INGRESO';
