...
export class SegConfigOpcionService {
  readonly urlMtto = environment.UrlSEGURIDADAPI + 'SEG_CONFIG_OPCION/';
  ...
  delete(id: number, param: any): any {
    ...
    if (param != null) {
      parametros = parametros.append('CORR_EMPRESA', param.CORR_EMPRESA);
      parametros = parametros.append('CODIGO_SISTEMA', param.CODIGO_SISTEMA);
      parametros = parametros.append('CODIGO_MENU', param.CODIGO_MENU);
    }
  ...
  getSistema(param: any): Observable<any[]> {
    ...
    return this.http.get<any[]>(this.urlMtto + 'GetSistema', { params: parametros });
  }

  getMenus(param: any): Observable<any[]> {
    ...
    return this.http.get<any[]>(this.urlMtto + 'GetMenus', { params: parametros });
  }

  getOpciones(param: any): Observable<any[]> {
    ...
    return this.http.get<any[]>(this.urlMtto + 'GetOpciones', { params: parametros });
  }
}
