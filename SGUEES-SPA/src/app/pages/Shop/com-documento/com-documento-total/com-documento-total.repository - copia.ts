...
export class ComDocumentoTotalRepository {
	readonly xController = 'COM_DOCUMENTO_TOTAL';
  ...
  getRubrosTemporales(xWhere: IParam[]): Observable<IResult> {
		return this.objData.Get(this.xController, 'GetRubrosTemporales', xWhere, environment.UrlGENERALAPI);
	}
}
