...
export class ComProveedorUsuarioRepository {
	readonly xController = 'COM_PROVEEDOR_USUARIO';
  ...
  reasignarClave(model: any): Observable<IResult> {
		return this.objData.Post(model, this.xController, 'ReasignarClave', environment.UrlCOMPRASAPI);
	}
}
