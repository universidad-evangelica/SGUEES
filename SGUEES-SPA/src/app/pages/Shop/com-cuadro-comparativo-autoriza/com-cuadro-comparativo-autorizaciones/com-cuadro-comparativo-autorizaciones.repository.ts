...
export class ComCuadroComparativoAutorizacionesRepository {
	readonly xController = 'COM_CUADRO_COMPARATIVO_AUTORIZACIONES';

	constructor(private objData: CData) {}

	get(xWhere: IParam[]): Observable<IResult> {
		return this.objData.Get(this.xController, 'GetAll_COM_CUADRO_COMPARATIVO_AUTORIZA', xWhere, environment.UrlCOMPRASAPI);
	}
