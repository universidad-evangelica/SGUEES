...
import { ComCuadroComparativoAutorizaRepository } from './com-cuadro-comparativo-autoriza.repository';
...
import { ComCuadroComparativoOrdenCompraRepository } from '../com-cuadro-comparativo/com-cuadro_comparativo-orden_compra/com-cuadro-comparativo-orden-compra.repository';
...
export class ComCuadroComparativoService {
	constructor(
    private repo: ComCuadroComparativoAutorizaRepository,
	...
	getColumns(): any {
      ...
      { dataField: 'NUMERO_SOLI_COMPRA', caption: 'No. Sol. Compra', width: 150 },
			{ dataField: 'NUMERO_SOLI_COTIZACION', caption: 'No. Sol. Cotización ', width: 155 },
      { dataField: 'NUMERO_COTIZACION', caption: 'No. Cotización', width: 150 },
      { dataField: 'NUMERO_CUADRO_COMPARA', caption: 'No. Cuadro', width: 150 },
      { dataField: 'NUMERO_ORDEN', caption: 'No. Orden Compra', width: 150 },
			{ dataField: 'FECHA_CUADRO_COMPARATIVO', caption: 'Fecha Comparativo', width: 175, dataType: 'date' },
			{ dataField: 'NOMBRE_ESTADO_CUADRO_COMPARATIVO', caption: 'Estado', width: 145 },
			{ dataField: 'USUARIO_CUADRO_COMPARATIVO', caption: 'Usuario Comparativo', width: 160 },
  ...
  Autorizar(model: any): Observable<IResult> {
		let xWhere: IParam[] = [
      { Parameter: 'ANIO_PERIODO', Value: model.ANIO_PERIODO },
      { Parameter: 'CORR_CUADRO_COMPARATIVO', Value: model.CORR_CUADRO_COMPARATIVO },
    ];
		return this.repo.Autorizar(model, xWhere);
	}
  ...
  //#endregion
  Rechazar(model: any): Observable<IResult> {
		let xWhere: IParam[] = [
      { Parameter: 'ANIO_PERIODO', Value: model.ANIO_PERIODO },
      { Parameter: 'CORR_CUADRO_COMPARATIVO', Value: model.CORR_CUADRO_COMPARATIVO },
    ];
		return this.repo.Rechazar(model, xWhere);
	}
