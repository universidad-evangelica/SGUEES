...
export class ComCuadroComparativoDetaRepository {
	...
	get(xWhere: IParam[]): Observable<IResult> {
		return this.objData.Get(this.xController, 'getAllCOM_CUADRO_COMPARATIVO_DETA', xWhere, environment.UrlCOMPRASAPI);
	}
	...
	update(model: any, xWhere: IParam[]): Observable<IResult> {
		return this.objData.Put(model, this.xController, 'PutCOM_CUADRO_COMPARATIVO_DETA', xWhere, environment.UrlCOMPRASAPI);
	}
