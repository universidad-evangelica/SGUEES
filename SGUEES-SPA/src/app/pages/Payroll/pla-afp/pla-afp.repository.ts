// Qué hace: acceso HTTP al API de AFP.
// Cómo lo hace: llama al controller PLA_AFP vía CData (Talento Humano API).
...
export class PlaAfpRepository {
	readonly xController = 'PLA_AFP';
