// Qué hace: acceso HTTP al API de Seguro Social.
// Cómo lo hace: llama al controller PLA_SEGURO_SOCIAL vía CData (Talento Humano API).
...
export class PlaSeguroSocialRepository {
	readonly xController = 'PLA_SEGURO_SOCIAL';
