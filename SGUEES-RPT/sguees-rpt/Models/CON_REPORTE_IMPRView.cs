...
{
	/// <summary>
	/// Filas de impresion para reportes contables oleada 1 (Balance, Libro Diario, Estado de Resultados).
	/// Misma forma que COM_*_IMPRView en Compras: la API envia List&lt;CON_REPORTE_IMPRView&gt; al RPT.
	/// </summary>
	public class CON_REPORTE_IMPRView
	{
