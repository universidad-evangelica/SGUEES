/* Menú — Documentos Bancarios, Cheques y procesos (SGUEES) */
...
INSERT INTO @Opciones (CODIGO, NOMBRE, URL, ORD) VALUES
    ...
    (N'BAN_CHEQUE',            N'Cheques',                          N'/ban-cheque',            1),

    (N'BAN_CHEQUE_APLICAR',    N'Aplicar Cheques',                  N'/ban-cheque-aplicar',    2),

    (N'BAN_CHEQUE_IMPRIMIR',   N'Imprimir Cheques',                 N'/ban-cheque-imprimir',   3),

    (N'BAN_CHEQUE_ANULAR',     N'Anular Cheques',                   N'/ban-cheque-anular',     4),

    (N'BAN_DOCUMENTO',         N'Documentos Bancarios',             N'/ban-documento',         5),

    (N'BAN_DOCUMENTO_APLICAR', N'Documentos Bancarios a Aplicar',   N'/ban-documento-aplicar', 6),

    (N'BAN_DOCUMENTO_ANULAR',  N'Documentos Bancarios a Anular',    N'/ban-documento-anular',  7),

    (N'BAN_DOCUMENTO_CONTABILIZAR', N'Contabilizar Documentos Bancarios', N'/ban-documento-contabilizar', 8);
...
/* Permisos para usuarios que ya tienen alguna opción BAN en el mismo menú */
...
WHERE u.CODIGO_SISTEMA = @SISTEMA
  ...
  AND u.CODIGO_OPCION IN (N'BAN_CHEQUE', N'BAN_DOCUMENTO')
...
PRINT N'Menu BAN documentos/cheques/procesos configurado.';
