...
/* Renombra estados de token:
   PENDIENTE -> ENVIADO
   UTILIZADO -> COMPLETADO
   No toca GENERADO, EXPIRADO, REVOCADO ni ERROR_ENVIO.
   Recrea los SP que comparan ESTADO_TOKEN. No ejecuta DDL de tablas. */

UPDATE dbo.SC_SOLICITUD_EMPLEO_TOKEN
   SET ESTADO_TOKEN = 'ENVIADO'
 WHERE ESTADO_TOKEN = 'PENDIENTE';
GO

UPDATE dbo.SC_SOLICITUD_EMPLEO_TOKEN
   SET ESTADO_TOKEN = 'COMPLETADO'
 WHERE ESTADO_TOKEN = 'UTILIZADO';
GO
