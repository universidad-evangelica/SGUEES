/* Menú — Conciliación Bancaria (SGUEES) */
...
INSERT INTO @Opciones (CODIGO, NOMBRE, URL, ORD) VALUES
    (N'BAN_CONCILIA_BANCARIA', N'Conciliación Bancaria', N'/ban-concilia-bancaria', 9);
...
PRINT N'Menu BAN conciliación bancaria configurado.';
GO
