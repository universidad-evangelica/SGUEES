/* Menú — Contabilizar Documentos Bancarios (SGUEES) */
SET NOCOUNT ON;
...
DECLARE @ORD_OPCION  int         = 8;
DECLARE @LOGIN       varchar(30) = 'admin';
DECLARE @USR         varchar(30) = 'admin';
DECLARE @EST         varchar(30) = 'SISTEMA';
DECLARE @HOY         datetime    = GETDATE();
DECLARE @CODIGO      varchar(30) = 'BAN_DOCUMENTO_CONTABILIZAR';

MERGE SEG_OPCION_SISTEMA AS T
USING (VALUES (@CODIGO, N'Contabilizar Documentos Bancarios', N'/ban-documento-contabilizar')) AS S
...
PRINT N'Menu BAN_DOCUMENTO_CONTABILIZAR aplicado.';
GO
