...
{
    public class SEG_FLUJO_TIPO_MOVIMIENTORepository : BaseRepository<SEG_FLUJO_TIPO_MOVIMIENTOTable>, ISEG_FLUJO_TIPO_MOVIMIENTORepository
    {
        private const string _TableName = "SEG_FLUJO_TIPO_MOVIMIENTO";

        public SEG_FLUJO_TIPO_MOVIMIENTORepository(IConfiguration config) :
        ...
        public async Task<CResult> GetAllAsync(List<CParameter> xWhere)
        {
            ...
            try
            {
                ...
                var response = new List<SEG_FLUJO_TIPO_MOVIMIENTOView>().FromDataReader(reader).ToList();
        ...
        public async Task<CResult> GetAsync(List<CParameter> xWhere)
        {
            ...
            {
                var reader = await objData.GetDataReader("V_" + _TableName, xWhere);
                var response = new List<SEG_FLUJO_TIPO_MOVIMIENTOView>().FromDataReader(reader).FirstOrDefault();
        ...
        public async Task<CResult> CreateAsync(SEG_FLUJO_TIPO_MOVIMIENTOTable Data, string vLOGIN_SISTEMA, string vESTACION)
        {
            ...
            try
            {
                ...
                objResultado.Result = true;
                objResultado.RowsAffected = 1;
                objResultado.CodeHelper = response.CORR_TIPO_MOVIMIENTO;
                objResultado.ErrorCode = 0;
                objResultado.ErrorMessage = "";
                objResultado.ErrorSource = "";
            }
