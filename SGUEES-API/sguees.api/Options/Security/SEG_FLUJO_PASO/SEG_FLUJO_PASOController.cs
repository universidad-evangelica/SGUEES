...
namespace sguees.Controllers
{
    ...
    public class SEG_FLUJO_PASOController : ControllerBase
    {
        private readonly ISEG_FLUJO_PASOService _service;
        
        public SEG_FLUJO_PASOController(ISEG_FLUJO_PASOService service)
        {
