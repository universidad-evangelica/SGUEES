...
{
    public class SEG_FLUJO_PASOView
    {
        ...
        // Campos para mostrar en grid (JOINs)
        public string NOMBRE_FLUJO { get; set; }
        public string NOMBRE_ACTOR { get; set; }
        public string NOMBRE_ACTOR_DESTINO { get; set; }
        public string NOMBRE_ESTADO_ORIGEN { get; set; }
        public string NOMBRE_ESTADO_ORIGEN_ALT { get; set; }
        public string NOMBRE_PASO_RETORNO { get; set; }
        public string NOMBRE_UNIDAD_DESTINO { get; set; }
    }
}