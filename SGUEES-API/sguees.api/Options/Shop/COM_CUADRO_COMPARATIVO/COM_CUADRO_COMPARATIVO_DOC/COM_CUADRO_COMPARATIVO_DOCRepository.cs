...
{
	public class COM_CUADRO_COMPARATIVO_DOCRepository: BaseRepository<COM_CUADRO_COMPARATIVO_DOCTable>, ICOM_CUADRO_COMPARATIVO_DOCRepository
	{
		private const string _TableName = "COM_CUADRO_COMPARATIVO_DOC";
		
		public COM_CUADRO_COMPARATIVO_DOCRepository(IConfiguration config) : 
		...
		public async Task<CResult> GetAllAsync(List<CParameter> xWhere)
		{
			...
			try
			{
				...
				var response = new List<COM_CUADRO_COMPARATIVO_DOCView>().FromDataReader(reader).ToList();
		...
		public async Task<CResult> GetAsync(List<CParameter> xWhere)
		{
			...
			{
				var reader = await objData.GetDataReader("V_"+_TableName, xWhere);
				var response = new List<COM_CUADRO_COMPARATIVO_DOCView>().FromDataReader(reader).FirstOrDefault();
