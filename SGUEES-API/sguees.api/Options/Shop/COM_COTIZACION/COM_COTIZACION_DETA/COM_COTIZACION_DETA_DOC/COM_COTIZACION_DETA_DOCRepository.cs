...
{
	public class COM_COTIZACION_DETA_DOCRepository: BaseRepository<COM_COTIZACION_DETA_DOCTable>, ICOM_COTIZACION_DETA_DOCRepository
	{
		private const string _TableName = "COM_COTIZACION_DETA_DOC";
		
		public COM_COTIZACION_DETA_DOCRepository(IConfiguration config) : 
		...
		public async Task<CResult> GetAllAsync(List<CParameter> xWhere)
		{
			...
			try
			{
				...
				var response = new List<COM_COTIZACION_DETA_DOCView>().FromDataReader(reader).ToList();
		...
		public async Task<CResult> GetAsync(List<CParameter> xWhere)
		{
			...
			{
				var reader = await objData.GetDataReader("V_"+_TableName, xWhere);
				var response = new List<COM_COTIZACION_DETA_DOCView>().FromDataReader(reader).FirstOrDefault();
