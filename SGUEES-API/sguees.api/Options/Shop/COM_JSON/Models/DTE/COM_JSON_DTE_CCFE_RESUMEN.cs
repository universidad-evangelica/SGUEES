...
{
    public class COM_JSON_DTE_CCFE_RESUMEN
    {
        ...
        public decimal ivaPerci1 { get; set; }                           //IVA Percibido
        ...
        public List<COM_JSON_DTE_PAGO> pagos { get; set; }                           //Pagos
        public string numPagoElectronico { get; set; }                  //Número de Pago Electrónico
    }
}
