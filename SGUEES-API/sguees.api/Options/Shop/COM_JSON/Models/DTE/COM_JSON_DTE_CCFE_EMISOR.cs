...
{
    public class COM_JSON_DTE_CCFE_EMISOR
    {
        ...
        public string codEstableMH { get; set; }                //Código del establecimiento asignado por el MH
        public string codEstable { get; set; }                  //Código del establecimiento asignado por el contribuyente
        public string codPuntoVentaMH { get; set; }             //Código del Punto de Venta (Emisor) Asignado por el MH
        public string codPuntoVenta { get; set; }               //Código del Punto de Venta (Emisor) asignado por el contribuyente
    }
}
