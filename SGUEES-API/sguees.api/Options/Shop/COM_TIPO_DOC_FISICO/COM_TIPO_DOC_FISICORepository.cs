...
{
	public class COM_TIPO_DOC_FISICORepository: BaseRepository<COM_TIPO_DOC_FISICOTable>, ICOM_TIPO_DOC_FISICORepository
	{
		private const string _TableName = "COM_TIPO_DOC_FISICO";
		
		public COM_TIPO_DOC_FISICORepository(IConfiguration config) : 
		...
		public async Task<CResult> GetAllAsync(List<CParameter> xWhere)
		{
			...
			try
			{
				...
				var response = new List<COM_TIPO_DOC_FISICOView>().FromDataReader(reader).ToList();
		...
		public async Task<CResult> GetAsync(List<CParameter> xWhere)
		{
			...
			{
				var reader = await objData.GetDataReader("V_"+_TableName, xWhere);
				var response = new List<COM_TIPO_DOC_FISICOView>().FromDataReader(reader).FirstOrDefault();
		...
		public async Task<CResult> CreateAsync(COM_TIPO_DOC_FISICOTable Data, string vLOGIN_SISTEMA, string vESTACION)
		{
			...
			try
			{
				var p = new List<CParameter>
				{
					...
					new CParameter() {ParameterName="NOMBRE_TIPO_DOCUMENTO",Value=Data.NOMBRE_TIPO_DOCUMENTO,DbType=System.Data.DbType.String},
					new CParameter() {ParameterName="NOMBRE_CORTO_TIPO_DOC",Value=Data.NOMBRE_CORTO_TIPO_DOC,DbType=System.Data.DbType.String},
