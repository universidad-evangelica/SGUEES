...
{
    public class ACA_BEC_ENTIDAD_FINANCIADORARepository : BaseRepository<ACA_BEC_ENTIDAD_FINANCIADORATable>, IACA_BEC_ENTIDAD_FINANCIADORARepository
    {
        private const string _TableName = "ACA_BEC_ENTIDAD_FINANCIADORA";
        private const string _ViewName = "V_ACA_BEC_ENTIDAD_FINANCIADORA";
        private const string _CampoPk = "CORR_ENTIDAD_FINANCIADORA";
        private const string _CampoEstado = "ACTIVO";
        private const bool _UsaEmpresa = true;

        public ACA_BEC_ENTIDAD_FINANCIADORARepository(IConfiguration config) :
            ...
            try
            {
                var dbWhere = xWhere
                    .Where(x => x.ParameterName == "CORR_EMPRESA" ||
                        ...
                        x.ParameterName == "CODIGO_ENTIDAD" ||
                        x.ParameterName == "NOMBRE_ENTIDAD" ||
                        x.ParameterName == "TIPO_ENTIDAD" ||
                        x.ParameterName == "ACTIVO")
                    .ToList();

                var reader = await objData.GetDataReader(_ViewName, dbWhere);
                var response = new List<ACA_BEC_ENTIDAD_FINANCIADORAView>().FromDataReader(reader)
                    .OrderBy(x => x.CORR_ENTIDAD_FINANCIADORA)
                    .ToList();
        ...
        public async Task<CResult> GetAsync(List<CParameter> xWhere)
        {
            ...
            try
            {
                ...
                var response = new List<ACA_BEC_ENTIDAD_FINANCIADORAView>().FromDataReader(reader).FirstOrDefault();

                reader.Close();
                result.Data = response;
                result.Result = true;
                result.RowsAffected = response == null ? 0 : 1;
                result.CodeHelper = response?.CORR_ENTIDAD_FINANCIADORA ?? 0;
                result.ErrorCode = 0;
                result.ErrorMessage = string.Empty;
                result.ErrorSource = string.Empty;
            }
        ...
        public async Task<CResult> UpdateAsync(ACA_BEC_ENTIDAD_FINANCIADORATable Data, string vLOGIN_SISTEMA, string vESTACION)
        {
            ...
            try
            {
                ...
                result.Result = true;
                result.RowsAffected = response == null ? 0 : 1;
                result.CodeHelper = response?.CORR_ENTIDAD_FINANCIADORA ?? Data.CORR_ENTIDAD_FINANCIADORA;
                result.ErrorCode = 0;
                result.ErrorMessage = string.Empty;
                result.ErrorSource = string.Empty;
            }
        ...
        public async Task<CResult> DeleteAsync(ACA_BEC_ENTIDAD_FINANCIADORATable Data, string vLOGIN_SISTEMA, string vESTACION)
        {
            ...
            try
            {
                ...
                result.Data = null;
                result.Result = true;
                result.CodeHelper = Data.CORR_ENTIDAD_FINANCIADORA;
                result.ErrorCode = 0;
                result.ErrorMessage = string.Empty;
                result.ErrorSource = string.Empty;
            }
            catch (Exception e)
            {
                ...
                result.CodeHelper = Data.CORR_ENTIDAD_FINANCIADORA;
                result.ErrorCode = -1;
                result.ErrorMessage = "No se puede eliminar la entidad financiadora porque tiene registros asociados.";
        ...
        public async Task<CResult> ActivarInactivarAsync(ACA_BEC_ENTIDAD_FINANCIADORATable Data, string vLOGIN_SISTEMA, string vESTACION)
        {
            ...
            try
            {
                var p = new List<CParameter>
                {
                    ...
                    new CParameter() { ParameterName = "CORR_RELATIVO", Value = Data.CORR_ENTIDAD_FINANCIADORA, DbType = System.Data.DbType.Int32 },
            ...
            {
                SetError(result, e, Data.CORR_ENTIDAD_FINANCIADORA);
            }
            finally
            {
                objData.objConnection.Close();
        ...
        private static List<CParameter> BuildInsertParameters(ACA_BEC_ENTIDAD_FINANCIADORATable Data)
        {
            ...
            p.Insert(1, new CParameter() { ParameterName = "CORR_ENTIDAD_FINANCIADORA", Value = Data.CORR_ENTIDAD_FINANCIADORA, DbType = System.Data.DbType.Int32, Direction = System.Data.ParameterDirection.InputOutput });
        ...
        private static List<CParameter> BuildUpdateParameters(ACA_BEC_ENTIDAD_FINANCIADORATable Data)
        {
            return new List<CParameter>
            {
                new CParameter() { ParameterName = "CODIGO_ENTIDAD", Value = Data.CODIGO_ENTIDAD, DbType = System.Data.DbType.String },
                new CParameter() { ParameterName = "NOMBRE_ENTIDAD", Value = Data.NOMBRE_ENTIDAD, DbType = System.Data.DbType.String },
                new CParameter() { ParameterName = "TIPO_ENTIDAD", Value = Data.TIPO_ENTIDAD, DbType = System.Data.DbType.String },
                new CParameter() { ParameterName = "CONTACTO", Value = Data.CONTACTO, DbType = System.Data.DbType.String },
                new CParameter() { ParameterName = "TELEFONO", Value = Data.TELEFONO, DbType = System.Data.DbType.String },
                new CParameter() { ParameterName = "CORREO", Value = Data.CORREO, DbType = System.Data.DbType.String },
        ...
        private static List<CParameter> BuildCompanyWhere(ACA_BEC_ENTIDAD_FINANCIADORATable Data)
        {
            return new List<CParameter>
            {
                new CParameter() { ParameterName = "CORR_EMPRESA", Value = Data.CORR_EMPRESA, DbType = System.Data.DbType.Int32 },
        ...
        private static List<CParameter> BuildPrimaryWhere(ACA_BEC_ENTIDAD_FINANCIADORATable Data)
        {
            return new List<CParameter>
            {
                new CParameter() { ParameterName = "CORR_EMPRESA", Value = Data.CORR_EMPRESA, DbType = System.Data.DbType.Int32 },
        ...
        private static void SetDuplicateAwareError(CResult result, Exception e)
        {
            SetError(result, e, 0, IsDuplicateKeyError(e)
                ? "Ya existe una entidad financiadora con ese identificador o codigo."
                : e.Message,
