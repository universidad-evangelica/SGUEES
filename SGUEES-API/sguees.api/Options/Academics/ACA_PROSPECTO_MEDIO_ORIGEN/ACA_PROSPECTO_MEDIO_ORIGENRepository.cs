...
namespace sguees.Repositories
{
    public class ACA_PROSPECTO_MEDIO_ORIGENRepository : BaseRepository<ACA_PROSPECTO_MEDIO_ORIGENTable>, IACA_PROSPECTO_MEDIO_ORIGENRepository
    {
        ...
        public Task<CResult> CreateAsync(ACA_PROSPECTO_MEDIO_ORIGENTable Data, string vLOGIN_SISTEMA, string vESTACION)
        {
            return Task.FromResult(OperacionNoHabilitada());
        }

        public Task<CResult> UpdateAsync(ACA_PROSPECTO_MEDIO_ORIGENTable Data, string vLOGIN_SISTEMA, string vESTACION)
        {
            return Task.FromResult(OperacionNoHabilitada());
        }

        public Task<CResult> DeleteAsync(ACA_PROSPECTO_MEDIO_ORIGENTable Data, string vLOGIN_SISTEMA, string vESTACION)
        {
            return Task.FromResult(OperacionNoHabilitada());
        }
