...
namespace sguees.Repositories
{
    public class ACA_PROSPECTO_LIMITACION_FISICARepository : BaseRepository<ACA_PROSPECTO_LIMITACION_FISICATable>, IACA_PROSPECTO_LIMITACION_FISICARepository
    {
        ...
        public Task<CResult> CreateAsync(ACA_PROSPECTO_LIMITACION_FISICATable Data, string vLOGIN_SISTEMA, string vESTACION)
        {
            return Task.FromResult(OperacionNoHabilitada());
        }

        public Task<CResult> UpdateAsync(ACA_PROSPECTO_LIMITACION_FISICATable Data, string vLOGIN_SISTEMA, string vESTACION)
        {
            return Task.FromResult(OperacionNoHabilitada());
        }

        public Task<CResult> DeleteAsync(ACA_PROSPECTO_LIMITACION_FISICATable Data, string vLOGIN_SISTEMA, string vESTACION)
        {
            return Task.FromResult(OperacionNoHabilitada());
        }
