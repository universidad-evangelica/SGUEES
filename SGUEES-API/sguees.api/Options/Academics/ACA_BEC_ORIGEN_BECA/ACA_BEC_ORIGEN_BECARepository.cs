...
{
    public class ACA_BEC_ORIGEN_BECARepository : BaseRepository<ACA_BEC_ORIGEN_BECATable>, IACA_BEC_ORIGEN_BECARepository
    {
        private const string _TableName = "ACA_BEC_ORIGEN_BECA";
        private const string _ViewName = "V_ACA_BEC_ORIGEN_BECA";
        private const string _CampoPk = "CORR_ORIGEN_BECA";
        private const string _CampoEstado = "ACTIVO";
        private const bool _UsaEmpresa = true;

        public ACA_BEC_ORIGEN_BECARepository(IConfiguration config) :
            ...
            try
            {
                var dbWhere = xWhere
                    .Where(x => x.ParameterName == "CORR_EMPRESA" ||
                        ...
                        x.ParameterName == "CODIGO_ORIGEN" ||
                        x.ParameterName == "NOMBRE_ORIGEN" ||
                        x.ParameterName == "ACTIVO")
                    .ToList();

                var reader = await objData.GetDataReader(_ViewName, dbWhere);
                var response = new List<ACA_BEC_ORIGEN_BECAView>().FromDataReader(reader)
        ...
        public async Task<CResult> GetAsync(List<CParameter> xWhere)
        {
            ...
            try
            {
                ...
                var response = new List<ACA_BEC_ORIGEN_BECAView>().FromDataReader(reader).FirstOrDefault();
                ...
                objResultado.CodeHelper = response?.CORR_ORIGEN_BECA ?? 0;
                objResultado.ErrorCode = 0;
                objResultado.ErrorMessage = "";
                objResultado.ErrorSource = "";
            }
        ...
        public async Task<CResult> CreateAsync(ACA_BEC_ORIGEN_BECATable Data, string vLOGIN_SISTEMA, string vESTACION)
        {
            ...
            try
            {
                var p = new List<CParameter>
                {
                    ...
                    new CParameter() { ParameterName = "CORR_ORIGEN_BECA", Value = Data.CORR_ORIGEN_BECA, DbType = System.Data.DbType.Int32, Direction = System.Data.ParameterDirection.InputOutput },
                    new CParameter() { ParameterName = "CODIGO_ORIGEN", Value = Data.CODIGO_ORIGEN, DbType = System.Data.DbType.String },
                    new CParameter() { ParameterName = "NOMBRE_ORIGEN", Value = Data.NOMBRE_ORIGEN, DbType = System.Data.DbType.String },
            ...
            catch (Exception e)
            {
                ...
                objResultado.ErrorMessage = duplicateKey
                    ? "Ya existe un origen de beca con ese codigo. Seleccione otro codigo para continuar."
                    : e.Message;
                objResultado.ErrorSource += $"[{e.Source}]";
            }
            finally
        ...
        public async Task<CResult> UpdateAsync(ACA_BEC_ORIGEN_BECATable Data, string vLOGIN_SISTEMA, string vESTACION)
        {
            ...
            try
            {
                ...
                objResultado.Result = true;
                objResultado.RowsAffected = response == null ? 0 : 1;
                objResultado.CodeHelper = response?.CORR_ORIGEN_BECA ?? Data.CORR_ORIGEN_BECA;
                objResultado.ErrorCode = 0;
                objResultado.ErrorMessage = "";
                objResultado.ErrorSource = "";
            }
        ...
        public async Task<CResult> DeleteAsync(ACA_BEC_ORIGEN_BECATable Data, string vLOGIN_SISTEMA, string vESTACION)
        {
            ...
            try
            {
                ...
                objResultado.Data = null;
                objResultado.Result = true;
                objResultado.CodeHelper = Data.CORR_ORIGEN_BECA;
                objResultado.ErrorCode = 0;
                objResultado.ErrorMessage = "";
                objResultado.ErrorSource = "";
            }
            catch (Exception e)
            {
                ...
                objResultado.CodeHelper = 0;
                objResultado.ErrorCode = -1;
                objResultado.ErrorMessage = "No se puede eliminar el origen de beca porque tiene registros asociados en otras tablas.";
                objResultado.ErrorSource += $"[{e.Source}]";
            }
            finally
            {
        ...
        public async Task<CResult> ActivarInactivarAsync(ACA_BEC_ORIGEN_BECATable Data, string vLOGIN_SISTEMA, string vESTACION)
        {
            ...
            try
            {
                var p = new List<CParameter>
                {
                    ...
                    new CParameter() { ParameterName = "CORR_EMPRESA", Value = Data.CORR_EMPRESA, DbType = System.Data.DbType.Int32 },
                    new CParameter() { ParameterName = "CORR_RELATIVO", Value = Data.CORR_ORIGEN_BECA, DbType = System.Data.DbType.Int32 },
                ...
                if ((int)objData.objCommand.Parameters["@SYS_NUMERO_ERROR"].Value == 0)
                {
                    ...
                    var response = new List<ACA_BEC_ORIGEN_BECAView>().FromDataReader(readerGet).FirstOrDefault();
