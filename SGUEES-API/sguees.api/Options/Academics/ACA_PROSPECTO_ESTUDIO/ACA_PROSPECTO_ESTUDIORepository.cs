...
namespace sguees.Repositories
{
    public class ACA_PROSPECTO_ESTUDIORepository : BaseRepository<ACA_PROSPECTO_ESTUDIOTable>, IACA_PROSPECTO_ESTUDIORepository
    {
        ...
        public Task<CResult> CreateAsync(ACA_PROSPECTO_ESTUDIOTable Data, string vLOGIN_SISTEMA, string vESTACION)
        {
            return Task.FromResult(OperacionNoHabilitada());
        }

        public Task<CResult> UpdateAsync(ACA_PROSPECTO_ESTUDIOTable Data, string vLOGIN_SISTEMA, string vESTACION)
        {
            return Task.FromResult(OperacionNoHabilitada());
        }

        public Task<CResult> DeleteAsync(ACA_PROSPECTO_ESTUDIOTable Data, string vLOGIN_SISTEMA, string vESTACION)
        {
            return Task.FromResult(OperacionNoHabilitada());
        }
