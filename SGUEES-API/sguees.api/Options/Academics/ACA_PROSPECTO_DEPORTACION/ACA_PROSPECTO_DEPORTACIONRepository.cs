...
namespace sguees.Repositories
{
    public class ACA_PROSPECTO_DEPORTACIONRepository : BaseRepository<ACA_PROSPECTO_DEPORTACIONTable>, IACA_PROSPECTO_DEPORTACIONRepository
    {
        ...
        public Task<CResult> CreateAsync(ACA_PROSPECTO_DEPORTACIONTable Data, string vLOGIN_SISTEMA, string vESTACION)
        {
            return Task.FromResult(OperacionNoHabilitada());
        }

        public Task<CResult> UpdateAsync(ACA_PROSPECTO_DEPORTACIONTable Data, string vLOGIN_SISTEMA, string vESTACION)
        {
            return Task.FromResult(OperacionNoHabilitada());
        }

        public Task<CResult> DeleteAsync(ACA_PROSPECTO_DEPORTACIONTable Data, string vLOGIN_SISTEMA, string vESTACION)
        {
            return Task.FromResult(OperacionNoHabilitada());
        }
