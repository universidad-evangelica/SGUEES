	...
	public class BAN_DOCUMENTORepository : BaseRepository<BAN_DOCUMENTOTable>, IBAN_DOCUMENTORepository
	{
			...
			string vESTACION)
		{
			...
			return new List<CParameter>
			{
				...
				new() { ParameterName = "CORR_CUENTA_BANCO_DESTINO", Value = Data.CORR_CUENTA_BANCO_DESTINO, DbType = System.Data.DbType.Int32 },
				new() { ParameterName = "NUMERO_CUENTA_DESTINO_TERCERO", Value = Data.NUMERO_CUENTA_DESTINO_TERCERO, DbType = System.Data.DbType.String },
				new() { ParameterName = "MONTO_DESTINO", Value = Data.MONTO_DESTINO ?? 0m, DbType = System.Data.DbType.Decimal },
