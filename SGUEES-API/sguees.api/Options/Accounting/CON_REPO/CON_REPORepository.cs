...

{
...

	{
		...
		public async Task<Stream> GetConReporteImprAsync(List<CON_REPORTE_IMPRView> data, string rptEndpoint, string token)

		{

			objData.Token = token;

			return await objData.PostStreamAsync(data, "Accounting", rptEndpoint);
