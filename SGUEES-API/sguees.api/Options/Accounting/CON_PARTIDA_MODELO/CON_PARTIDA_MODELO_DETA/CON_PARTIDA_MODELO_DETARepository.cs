...
{
	public class CON_PARTIDA_MODELO_DETARepository : BaseRepository<CON_PARTIDA_MODELO_DETATable>, ICON_PARTIDA_MODELO_DETARepository
	{
		private const string _TableName = "CON_PARTIDA_DETA_MODELO";

		public CON_PARTIDA_MODELO_DETARepository(IConfiguration config) :
		...
		public async Task<CResult> GetAllAsync(List<CParameter> xWhere)
		{
			...
			try
			{
				...
				var response = new List<CON_PARTIDA_MODELO_DETAView>().FromDataReader(reader).ToList();
		...
		public async Task<CResult> GetAsync(List<CParameter> xWhere)
		{
			...
			{
				var reader = await objData.GetDataReader("V_" + _TableName, xWhere);
				var response = new List<CON_PARTIDA_MODELO_DETAView>().FromDataReader(reader).FirstOrDefault();
				reader.Close(); reader = null;
		...
		public async Task<CResult> CreateAsync(CON_PARTIDA_MODELO_DETATable Data, string vLOGIN_SISTEMA, string vESTACION)
		{
			CResult objResultado = new();
			try
			{
		...
		public async Task<CResult> UpdateAsync(CON_PARTIDA_MODELO_DETATable Data, string vLOGIN_SISTEMA, string vESTACION)
		{
			CResult objResultado = new();
			try
			{
		...
		public async Task<CResult> DeleteAsync(CON_PARTIDA_MODELO_DETATable Data, string vLOGIN_SISTEMA, string vESTACION)
		{
			CResult objResultado = new();
			try
			{
