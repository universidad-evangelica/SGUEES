...
{
	internal readonly struct ConReportEntry
	{
		public ConReportEntry(
			string codigo,
			string sp,
			string titulo,
			string destino,
			...
			string[] filtros)
		{
			...
			CrystalDetailTable = crystalDetailTable;
			UrlOpcion = urlOpcion;
			Filtros = filtros;
		}
		...
		public string CrystalDetailTable { get; }
