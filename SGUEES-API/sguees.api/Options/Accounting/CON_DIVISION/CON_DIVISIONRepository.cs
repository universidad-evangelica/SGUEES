...
{
	public class CON_DIVISIONRepository : BaseRepository<CON_DIVISIONTable>, ICON_DIVISIONRepository
	{
		private const string _TableName = "CON_DIVISION";

		public CON_DIVISIONRepository(IConfiguration config) :
		...
		public async Task<CResult> GetAllAsync(List<CParameter> xWhere)
		{
			...
			try
			{
				...
				var response = new List<CON_DIVISIONView>().FromDataReader(reader).ToList();
		...
		public async Task<CResult> GetAsync(List<CParameter> xWhere)
		{
			...
			{
				var reader = await objData.GetDataReader("V_" + _TableName, xWhere);
				var response = new List<CON_DIVISIONView>().FromDataReader(reader).FirstOrDefault();
				reader.Close(); reader = null;
		...
		public async Task<CResult> CreateAsync(CON_DIVISIONTable Data, string vLOGIN_SISTEMA, string vESTACION)
		{
			CResult objResultado = new();
			try
			{
		...
		public async Task<CResult> UpdateAsync(CON_DIVISIONTable Data, string vLOGIN_SISTEMA, string vESTACION)
		{
			CResult objResultado = new();
			try
			{
		...
		public async Task<CResult> DeleteAsync(CON_DIVISIONTable Data, string vLOGIN_SISTEMA, string vESTACION)
		{
			CResult objResultado = new();
			try
			{
