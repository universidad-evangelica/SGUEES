...
{
	public class CON_GERENCIARepository : BaseRepository<CON_GERENCIATable>, ICON_GERENCIARepository
	{
		private const string _TableName = "CON_GERENCIA";

		public CON_GERENCIARepository(IConfiguration config) :
		...
		public async Task<CResult> GetAllAsync(List<CParameter> xWhere)
		{
			...
			try
			{
				...
				var response = new List<CON_GERENCIAView>().FromDataReader(reader).ToList();
		...
		public async Task<CResult> GetAsync(List<CParameter> xWhere)
		{
			...
			{
				var reader = await objData.GetDataReader("V_" + _TableName, xWhere);
				var response = new List<CON_GERENCIAView>().FromDataReader(reader).FirstOrDefault();
				reader.Close(); reader = null;
		...
		public async Task<CResult> CreateAsync(CON_GERENCIATable Data, string vLOGIN_SISTEMA, string vESTACION)
		{
			CResult objResultado = new();
			try
			{
		...
		public async Task<CResult> UpdateAsync(CON_GERENCIATable Data, string vLOGIN_SISTEMA, string vESTACION)
		{
			CResult objResultado = new();
			try
			{
		...
		public async Task<CResult> DeleteAsync(CON_GERENCIATable Data, string vLOGIN_SISTEMA, string vESTACION)
		{
			CResult objResultado = new();
			try
			{
