...
{
    public class SC_DESCRIPTOR_IMPACTO_ECONOMICORepository : BaseRepository<SC_DESCRIPTOR_IMPACTO_ECONOMICOTable>, ISC_DESCRIPTOR_IMPACTO_ECONOMICORepository
    {
        private const string _TableName = "SC_DESCRIPTOR_IMPACTO_ECONOMICO";

        public SC_DESCRIPTOR_IMPACTO_ECONOMICORepository(IConfiguration config) :
        ...
        public async Task<CResult> GetAllAsync(List<CParameter> xWhere)
        {
            ...
            try
            {
                ...
                var response = new List<SC_DESCRIPTOR_IMPACTO_ECONOMICOView>().FromDataReader(reader).ToList();
        ...
        private static string GetColumnValue(SC_DESCRIPTOR_IMPACTO_ECONOMICOView row, string columnName)
        {
            switch (columnName)
            {
        ...
        public async Task<CResult> GetAsync(List<CParameter> xWhere)
        {
            ...
            try
            {
                ...
                var response = new List<SC_DESCRIPTOR_IMPACTO_ECONOMICOView>().FromDataReader(reader).FirstOrDefault();
