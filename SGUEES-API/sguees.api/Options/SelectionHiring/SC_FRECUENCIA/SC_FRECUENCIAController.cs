...
namespace SGUEES.Controllers
{
    ...
    public class SC_FRECUENCIAController : ControllerBase
    {
        ...
        // Atiende la consulta del listado de frecuencias y la limita a la empresa de la sesión.
        [HttpGet("GetAll")]
        ...
        // Atiende la consulta de una frecuencia dentro de la empresa de la sesión.
        [HttpGet("Get")]
        [Authorize(Policy = "/sc-frecuencia|R")]
        ...
        // Valida el contexto de empresa y elimina la frecuencia indicada por sus claves.
        [HttpDelete]
