...
{
	/// <summary>
	/// Payload RRHH para actualizar persona + colecciones (sin Confirmación).
	/// </summary>
	public class SC_SOLICITUD_EMPLEO_PERSONA_ACTUALIZARParam
	{
		[Required]
		...
		/// <summary>URL relativa tras SubirFotoPersona; vacío = conservar foto actual.</summary>
	...
	public class SC_SOLICITUD_EMPLEO_PERSONA_ACTUALIZARView
	{
