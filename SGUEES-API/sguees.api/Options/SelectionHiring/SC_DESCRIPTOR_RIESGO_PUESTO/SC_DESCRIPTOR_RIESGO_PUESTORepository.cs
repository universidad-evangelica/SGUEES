...
{
    public class SC_DESCRIPTOR_RIESGO_PUESTORepository : BaseRepository<SC_DESCRIPTOR_RIESGO_PUESTOTable>, ISC_DESCRIPTOR_RIESGO_PUESTORepository
    {
        private const string _TableName = "SC_DESCRIPTOR_RIESGO_PUESTO";

        public SC_DESCRIPTOR_RIESGO_PUESTORepository(IConfiguration config) :
        ...
        public async Task<CResult> GetAllAsync(List<CParameter> xWhere)
        {
            ...
            try
            {
                ...
                var response = new List<SC_DESCRIPTOR_RIESGO_PUESTOView>().FromDataReader(reader).ToList();
        ...
        private static string GetColumnValue(SC_DESCRIPTOR_RIESGO_PUESTOView row, string columnName)
        {
            switch (columnName)
            {
        ...
        public async Task<CResult> GetAsync(List<CParameter> xWhere)
        {
            ...
            try
            {
                ...
                var response = new List<SC_DESCRIPTOR_RIESGO_PUESTOView>().FromDataReader(reader).FirstOrDefault();
