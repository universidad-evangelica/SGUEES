// Contrato del servicio de responsabilidad del cargo.
...
namespace SGUEES.Services
{
    public interface ISC_RESPONSABILIDAD_CARGOService
    {
        ...
        // Define la consulta del listado de responsabilidades del cargo según los filtros recibidos.
        Task<CResult> GetAllAsync(SC_RESPONSABILIDAD_CARGOParam xWhere);
        // Define la consulta de una responsabilidad del cargo específica por sus claves.
        Task<CResult> GetAsync(SC_RESPONSABILIDAD_CARGOParam xWhere);
        // Define la creación validada de una responsabilidad del cargo con su información de auditoría.
        Task<CResult> CreateAsync(SC_RESPONSABILIDAD_CARGOTable Data, string vLOGIN_SISTEMA, string vESTACION);
        // Define la actualización validada de una responsabilidad del cargo con su información de auditoría.
        Task<CResult> UpdateAsync(SC_RESPONSABILIDAD_CARGOTable Data, string vLOGIN_SISTEMA, string vESTACION);
        // Define la eliminación de una responsabilidad del cargo identificada por sus claves.
