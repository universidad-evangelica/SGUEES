...
namespace SGUEES.Controllers
{
	...
	[ApiController]
	[Route("[controller]")]
	public class SC_EXPEDIENTE_ENTREVISTA_DOCUMENTOController : ControllerBase
	{
		private readonly ISC_EXPEDIENTE_ENTREVISTA_DOCUMENTOService _service;

		public SC_EXPEDIENTE_ENTREVISTA_DOCUMENTOController(ISC_EXPEDIENTE_ENTREVISTA_DOCUMENTOService service)
		{
		...
		{
			this.ApplyQueryKeys(Data, nameof(SC_EXPEDIENTE_ENTREVISTA_DOCUMENTOUploadTable.CORR_ENTREVISTA_DOCUMENTO));
			SetUpdateAudit(Data);
		...
		public async Task<IActionResult> GetDoc([FromQuery] SC_EXPEDIENTE_ENTREVISTA_DOCUMENTOParam Data)
		{
			...
			var fileName = string.IsNullOrWhiteSpace(Data.NOMBRE_ARCHIVO) ? "adjunto" : Data.NOMBRE_ARCHIVO;
			Response.Headers.ContentType = ExpedienteEntrevistaDocumentoStorage.GetContentType(fileName);
			Response.Headers.ContentDisposition = "inline";
			Response.RegisterForDispose(stream);

			return File(stream, ExpedienteEntrevistaDocumentoStorage.GetContentType(fileName));
		}
		...
		private void SetCreateAudit(SC_EXPEDIENTE_ENTREVISTA_DOCUMENTOUploadTable Data)
		{
			Data.CORR_EMPRESA = GetCorrEmpresa();
		...
		private void SetUpdateAudit(SC_EXPEDIENTE_ENTREVISTA_DOCUMENTOUploadTable Data)
		{
			Data.CORR_EMPRESA = GetCorrEmpresa();
		...
		private void SetUpdateAudit(SC_EXPEDIENTE_ENTREVISTA_DOCUMENTOTable Data)
		{
			Data.CORR_EMPRESA = GetCorrEmpresa();
			Data.USUARIO_ACTU = GetUsuario();
			Data.ESTACION_ACTU = ClientInfoHelper.GetClientStation(HttpContext);
