...
{
    public class SC_DESCRIPTOR_FUNCION_ACTIVIDADRepository : BaseRepository<SC_DESCRIPTOR_FUNCION_ACTIVIDADTable>, ISC_DESCRIPTOR_FUNCION_ACTIVIDADRepository
    {
        private const string _TableName = "SC_DESCRIPTOR_FUNCION_ACTIVIDAD";
        private const string _ViewName = "V_SC_DESCRIPTOR_FUNCION_ACTIVIDAD";

        public SC_DESCRIPTOR_FUNCION_ACTIVIDADRepository(IConfiguration config) :
        ...
        public async Task<CResult> GetAllAsync(List<CParameter> xWhere)
        {
            ...
            try
            {
                ...
                var response = new List<SC_DESCRIPTOR_FUNCION_ACTIVIDADView>().FromDataReader(reader)
        ...
        public async Task<CResult> GetAsync(List<CParameter> xWhere)
        {
            ...
            {
                var reader = await objData.GetDataReader(_ViewName, xWhere);
                var response = new List<SC_DESCRIPTOR_FUNCION_ACTIVIDADView>().FromDataReader(reader).FirstOrDefault();
