...
{
    public class SC_DESCRIPTOR_PUESTO_RELACION_LABORALService : ISC_DESCRIPTOR_PUESTO_RELACION_LABORALService
    {
        private readonly ISC_DESCRIPTOR_PUESTO_RELACION_LABORALRepository _repo;

        public SC_DESCRIPTOR_PUESTO_RELACION_LABORALService(ISC_DESCRIPTOR_PUESTO_RELACION_LABORALRepository repo)
        {
            _repo = repo;
        }

        // Obtiene el listado de relación laboral aplicando los filtros recibidos.
        public async Task<CResult> GetAllAsync(SC_DESCRIPTOR_PUESTO_RELACION_LABORALParam xWhere)
        {
            return await _repo.GetAllAsync(BuildParameters(xWhere));
        }

        // Obtiene un registro de relación laboral con los identificadores recibidos.
        public async Task<CResult> GetAsync(SC_DESCRIPTOR_PUESTO_RELACION_LABORALParam xWhere)
        {
        ...
        private static List<CParameter> BuildParameters(SC_DESCRIPTOR_PUESTO_RELACION_LABORALParam xWhere, bool includeRelacion = false)
        {
        ...
        private static CResult Validate(SC_DESCRIPTOR_PUESTO_RELACION_LABORALTable Data)
        {
        ...
        private static void NormalizeTipoRelacion(SC_DESCRIPTOR_PUESTO_RELACION_LABORALTable Data)
        {
