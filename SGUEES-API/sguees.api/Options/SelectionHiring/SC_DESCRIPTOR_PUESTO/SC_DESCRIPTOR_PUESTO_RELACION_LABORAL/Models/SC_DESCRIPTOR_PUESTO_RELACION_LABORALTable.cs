...
{
    // Campos de escritura de la tabla SC_DESCRIPTOR_PUESTO_RELACION_LABORAL: relaciones laborales internas/externas
    // (con otros puestos o áreas) asociadas a un descriptor de puesto.
    public class SC_DESCRIPTOR_PUESTO_RELACION_LABORALTable : BaseEntity
    {
