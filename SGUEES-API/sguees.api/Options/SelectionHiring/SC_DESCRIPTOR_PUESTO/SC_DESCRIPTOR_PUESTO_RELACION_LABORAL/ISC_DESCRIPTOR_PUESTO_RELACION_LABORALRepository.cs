...
{
    // Contrato del repositorio de SC_DESCRIPTOR_PUESTO_RELACION_LABORAL: acceso a datos de las relaciones laborales
    // del descriptor de puesto.
    public interface ISC_DESCRIPTOR_PUESTO_RELACION_LABORALRepository
    {
