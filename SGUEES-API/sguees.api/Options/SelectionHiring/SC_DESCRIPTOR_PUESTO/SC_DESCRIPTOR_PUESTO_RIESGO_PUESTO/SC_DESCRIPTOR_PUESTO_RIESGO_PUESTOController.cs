...
namespace SGUEES.Controllers
{
    ...
    [ApiController]
    [Route("[controller]")]
    public class SC_DESCRIPTOR_PUESTO_RIESGO_PUESTOController : ControllerBase
    {
        private readonly ISC_DESCRIPTOR_PUESTO_RIESGO_PUESTOService _service;

        public SC_DESCRIPTOR_PUESTO_RIESGO_PUESTOController(ISC_DESCRIPTOR_PUESTO_RIESGO_PUESTOService service)
        {
