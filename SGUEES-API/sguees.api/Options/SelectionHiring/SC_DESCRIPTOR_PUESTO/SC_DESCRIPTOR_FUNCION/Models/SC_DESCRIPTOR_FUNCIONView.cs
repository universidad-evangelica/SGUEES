...
{
    // Campos de lectura de la vista V_SC_DESCRIPTOR_FUNCION: función del descriptor con el conteo de sus actividades.
    public class SC_DESCRIPTOR_FUNCIONView
    {
        ...
        // Columna calculada por la vista: cantidad de actividades (SC_DESCRIPTOR_FUNCION_ACTIVIDAD) de la función.
