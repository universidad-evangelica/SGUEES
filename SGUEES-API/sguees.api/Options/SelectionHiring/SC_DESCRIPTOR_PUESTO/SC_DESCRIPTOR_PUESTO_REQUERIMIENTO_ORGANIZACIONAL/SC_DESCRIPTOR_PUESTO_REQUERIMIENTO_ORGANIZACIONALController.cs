...
namespace SGUEES.Controllers
{
    ...
    [ApiController]
    [Route("[controller]")]
    public class SC_DESCRIPTOR_PUESTO_REQUERIMIENTO_ORGANIZACIONALController : ControllerBase
    {
        private readonly ISC_DESCRIPTOR_PUESTO_REQUERIMIENTO_ORGANIZACIONALService _service;

        public SC_DESCRIPTOR_PUESTO_REQUERIMIENTO_ORGANIZACIONALController(ISC_DESCRIPTOR_PUESTO_REQUERIMIENTO_ORGANIZACIONALService service)
        {
