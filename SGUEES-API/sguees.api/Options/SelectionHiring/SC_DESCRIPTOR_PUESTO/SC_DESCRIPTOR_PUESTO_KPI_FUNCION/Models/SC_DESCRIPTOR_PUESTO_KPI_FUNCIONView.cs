...
{
    // Campos de lectura de la vista V_SC_DESCRIPTOR_PUESTO_KPI_FUNCION: indicadores (KPI) de desempeño del descriptor.
    public class SC_DESCRIPTOR_PUESTO_KPI_FUNCIONView
    {
