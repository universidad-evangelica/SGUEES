...
{
    public class SC_DESCRIPTOR_PUESTO_KPI_FUNCIONService : ISC_DESCRIPTOR_PUESTO_KPI_FUNCIONService
    {
        private readonly ISC_DESCRIPTOR_PUESTO_KPI_FUNCIONRepository _repo;

        public SC_DESCRIPTOR_PUESTO_KPI_FUNCIONService(ISC_DESCRIPTOR_PUESTO_KPI_FUNCIONRepository repo)
        {
            _repo = repo;
        }

        // Lista KPIs del descriptor; convierte filtros a parámetros SQL y consulta el repositorio.
        public async Task<CResult> GetAllAsync(SC_DESCRIPTOR_PUESTO_KPI_FUNCIONParam xWhere)
        {
            return await _repo.GetAllAsync(BuildParameters(xWhere));
        }

        // Obtiene un KPI por empresa, descriptor y CORR_KPI_FUNCION.
        public async Task<CResult> GetAsync(SC_DESCRIPTOR_PUESTO_KPI_FUNCIONParam xWhere)
        {
            return await _repo.GetAsync(BuildParameters(xWhere, includeKpi: true));
        }

        // Valida indicador, frecuencia y meta; luego inserta en SC_DESCRIPTOR_PUESTO_KPI_FUNCION.
        ...
        // Valida y actualiza un KPI existente en SC_DESCRIPTOR_PUESTO_KPI_FUNCION.
        ...
        // Valida claves y elimina el KPI de SC_DESCRIPTOR_PUESTO_KPI_FUNCION.
        ...
        private static List<CParameter> BuildParameters(SC_DESCRIPTOR_PUESTO_KPI_FUNCIONParam xWhere, bool includeKpi = false)
        {
        ...
        private static CResult Validate(SC_DESCRIPTOR_PUESTO_KPI_FUNCIONTable Data)
        {
