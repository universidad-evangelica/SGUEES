...
namespace SGUEES.Controllers
{
    ...
    [ApiController]
    [Route("[controller]")]
    public class SC_DESCRIPTOR_KPI_FUNCIONController : ControllerBase
    {
        private readonly ISC_DESCRIPTOR_KPI_FUNCIONService _service;

        public SC_DESCRIPTOR_KPI_FUNCIONController(ISC_DESCRIPTOR_KPI_FUNCIONService service)
        {
