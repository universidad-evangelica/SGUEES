...
{
    public class SC_DESCRIPTOR_PUESTO_FUNCION_ACTIVIDADService : ISC_DESCRIPTOR_PUESTO_FUNCION_ACTIVIDADService
    {
        private readonly ISC_DESCRIPTOR_PUESTO_FUNCION_ACTIVIDADRepository _repo;

        public SC_DESCRIPTOR_PUESTO_FUNCION_ACTIVIDADService(ISC_DESCRIPTOR_PUESTO_FUNCION_ACTIVIDADRepository repo)
        {
            _repo = repo;
        }

        // Obtiene el listado de actividad de la función aplicando los filtros recibidos.
        public async Task<CResult> GetAllAsync(SC_DESCRIPTOR_PUESTO_FUNCION_ACTIVIDADParam xWhere)
        {
            return await _repo.GetAllAsync(BuildParameters(xWhere));
        }

        // Obtiene un registro de actividad de la función con los identificadores recibidos.
        public async Task<CResult> GetAsync(SC_DESCRIPTOR_PUESTO_FUNCION_ACTIVIDADParam xWhere)
        {
        ...
        private static List<CParameter> BuildParameters(SC_DESCRIPTOR_PUESTO_FUNCION_ACTIVIDADParam xWhere, bool includeActividad = false)
        {
        ...
        private static CResult Validate(SC_DESCRIPTOR_PUESTO_FUNCION_ACTIVIDADTable Data)
        {
