...
{
    // Campos de escritura de la tabla SC_DESCRIPTOR_PUESTO_FUNCION: funciones (esenciales/periódicas) asociadas
    // a un descriptor de puesto.
    public class SC_DESCRIPTOR_PUESTO_FUNCIONTable : BaseEntity
    {
