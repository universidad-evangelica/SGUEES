...
{
    public class SC_DESCRIPTOR_PUESTO_FUNCIONService : ISC_DESCRIPTOR_PUESTO_FUNCIONService
    {
        private readonly ISC_DESCRIPTOR_PUESTO_FUNCIONRepository _repo;
        private readonly ISC_DESCRIPTOR_PUESTO_FUNCION_ACTIVIDADRepository _actividadRepo;

        public SC_DESCRIPTOR_PUESTO_FUNCIONService(
            ISC_DESCRIPTOR_PUESTO_FUNCIONRepository repo,
            ISC_DESCRIPTOR_PUESTO_FUNCION_ACTIVIDADRepository actividadRepo)
        {
            _repo = repo;
        ...
        public async Task<CResult> GetAllAsync(SC_DESCRIPTOR_PUESTO_FUNCIONParam xWhere)
        {
            return await _repo.GetAllAsync(BuildParameters(xWhere));
        }

        // Obtiene un registro de función del descriptor con los identificadores recibidos.
        public async Task<CResult> GetAsync(SC_DESCRIPTOR_PUESTO_FUNCIONParam xWhere)
        {
        ...
        private static List<CParameter> BuildParameters(SC_DESCRIPTOR_PUESTO_FUNCIONParam xWhere, bool includeFuncion = false)
        {
        ...
        private static CResult Validate(SC_DESCRIPTOR_PUESTO_FUNCIONTable Data)
        {
        ...
        private static void NormalizeTipoFuncion(SC_DESCRIPTOR_PUESTO_FUNCIONTable Data)
        {
