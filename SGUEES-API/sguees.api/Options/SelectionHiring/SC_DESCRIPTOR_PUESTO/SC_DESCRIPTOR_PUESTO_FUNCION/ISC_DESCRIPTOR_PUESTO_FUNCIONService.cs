...
{
    // Contrato del servicio de SC_DESCRIPTOR_PUESTO_FUNCION: reglas de negocio para las funciones del descriptor de puesto.
    public interface ISC_DESCRIPTOR_PUESTO_FUNCIONService
    {
        // Obtiene el listado de función del descriptor aplicando los filtros recibidos.
        Task<CResult> GetAllAsync(SC_DESCRIPTOR_PUESTO_FUNCIONParam xWhere);
        // Obtiene un registro de función del descriptor con los identificadores recibidos.
        Task<CResult> GetAsync(SC_DESCRIPTOR_PUESTO_FUNCIONParam xWhere);
