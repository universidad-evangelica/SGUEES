...
namespace sguees.Controllers
{
    ...
    [Route("[controller]")]
    [ApiController]
    public class SC_PERSONA_COMPETENCIAS_TECNICASController : ControllerBase
    {
        private readonly ISC_PERSONA_COMPETENCIAS_TECNICASService _service;
        public SC_PERSONA_COMPETENCIAS_TECNICASController(ISC_PERSONA_COMPETENCIAS_TECNICASService service) { _service = service ?? throw new ArgumentNullException(nameof(service)); }
        [HttpGet("GetAll")]
        ...
        public async Task<IActionResult> Post([FromBody] SC_PERSONA_COMPETENCIAS_TECNICASTable Data)
        {
        ...
        public async Task<IActionResult> Put([FromBody] SC_PERSONA_COMPETENCIAS_TECNICASTable Data, [FromQuery] int CORR_PERSONA_DATOS = 0, [FromQuery] int CORR_COMPETENCIA_TECNICA = 0)
        {
            Data.CORR_EMPRESA = Empresa(); if (CORR_PERSONA_DATOS > 0) Data.CORR_PERSONA_DATOS = CORR_PERSONA_DATOS; if (CORR_COMPETENCIA_TECNICA > 0) Data.CORR_COMPETENCIA_TECNICA = CORR_COMPETENCIA_TECNICA;
        ...
        public async Task<IActionResult> Delete([FromQuery] SC_PERSONA_COMPETENCIAS_TECNICASTable Data)
        {
