		...
		public async Task<CResult> CreateAsync(SC_PERSONA_DATOSTable Data, string vUSERNAME_SISTEMA, string vESTACION)
		{
			...
			try
			{
				var p = new List<CParameter>
				{
					...
					new CParameter() { ParameterName = "NOMBRE1", Value = Data.NOMBRE1, DbType = System.Data.DbType.String },
					new CParameter() { ParameterName = "NOMBRE2", Value = Data.NOMBRE2, DbType = System.Data.DbType.String },
					new CParameter() { ParameterName = "APELLIDO1", Value = Data.APELLIDO1, DbType = System.Data.DbType.String },
					new CParameter() { ParameterName = "APELLIDO2", Value = Data.APELLIDO2, DbType = System.Data.DbType.String },
				};
