...
namespace SGUEES.Repositories
{
    ...
    // Cómo: usa apiRptURL + JWT de GenerateRptToken; endpoints PostScDescriptorPuestoFormato{Corto,Extenso}Impr.
    public class SC_REPORepository : eFrameworkAPI.Data.BaseRepository, ISC_REPORepository
    {
        ...
        public Task<Stream> GetScDescriptorPuestoFormatoExtensoImprAsync(
            List<SC_DESCRIPTOR_PUESTO_IMPRView> data,
            string token)
        {
            objData.Token = token;
            return objData.PostStreamAsync(data, "SelectionHiring", "PostScDescriptorPuestoFormatoExtensoImpr");
        }
    }
}
