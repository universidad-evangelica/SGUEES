...
{
    public class SC_DESCRIPTOR_RESPONSABILIDAD_CARGORepository : BaseRepository<SC_DESCRIPTOR_RESPONSABILIDAD_CARGOTable>, ISC_DESCRIPTOR_RESPONSABILIDAD_CARGORepository
    {
        private const string _TableName = "SC_DESCRIPTOR_RESPONSABILIDAD_CARGO";

        public SC_DESCRIPTOR_RESPONSABILIDAD_CARGORepository(IConfiguration config) :
        ...
        public async Task<CResult> GetAllAsync(List<CParameter> xWhere)
        {
            ...
            try
            {
                ...
                var response = new List<SC_DESCRIPTOR_RESPONSABILIDAD_CARGOView>().FromDataReader(reader).ToList();
        ...
        private static string GetColumnValue(SC_DESCRIPTOR_RESPONSABILIDAD_CARGOView row, string columnName)
        {
            switch (columnName)
            {
        ...
        public async Task<CResult> GetAsync(List<CParameter> xWhere)
        {
            ...
            try
            {
                ...
                var response = new List<SC_DESCRIPTOR_RESPONSABILIDAD_CARGOView>().FromDataReader(reader).FirstOrDefault();
