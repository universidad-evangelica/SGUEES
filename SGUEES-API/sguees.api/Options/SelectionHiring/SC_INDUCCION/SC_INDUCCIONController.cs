...
namespace SGUEES.Controllers
{
    ...
    public class SC_INDUCCIONController : ControllerBase
    {
        ...
        // Atiende la consulta del listado de inducciones y la limita a la empresa de la sesión.
        [HttpGet("GetAll")]
        ...
        // Atiende la consulta de una inducción dentro de la empresa de la sesión.
        [HttpGet("Get")]
        [Authorize(Policy = "/sc-induccion|R")]
        ...
        // Valida el contexto de empresa y elimina la inducción indicada por sus claves.
        [HttpDelete]
