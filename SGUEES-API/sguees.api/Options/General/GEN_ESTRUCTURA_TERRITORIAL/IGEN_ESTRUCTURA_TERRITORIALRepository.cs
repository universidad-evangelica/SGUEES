...
namespace SGUEES.Repositories
{
	public interface IGEN_ESTRUCTURA_TERRITORIALRepository
	{
		...
		Task<CResult> GetDistinctValuesPaisesAsync(List<CParameter> xWhere);
		...
		Task<CResult> GetDistinctValuesDeptosAsync(List<CParameter> xWhere);
		...
		Task<CResult> GetDistinctValuesMunicipiosAsync(List<CParameter> xWhere);
		...
		Task<CResult> GetDistinctValuesDistritosAsync(List<CParameter> xWhere);
		...
		Task<bool> ExistsPaisByFieldAsync(string fieldName, string normalizedValue, int excludeCorrPais);
