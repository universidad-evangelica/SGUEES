...
namespace SGUEES.Services
{
	public interface IGEN_ESTRUCTURA_TERRITORIALService
	{
		...
		Task<CResult> GetDistinctValuesPaisesAsync(GEN_ESTRUCTURA_TERRITORIAL_PAISParam xWhere);
		...
		Task<CResult> GetDistinctValuesDeptosAsync(GEN_ESTRUCTURA_TERRITORIAL_DEPTOParam xWhere);
		...
		Task<CResult> GetDistinctValuesMunicipiosAsync(GEN_ESTRUCTURA_TERRITORIAL_MUNICIPIOParam xWhere);
		...
		Task<CResult> GetDistinctValuesDistritosAsync(GEN_ESTRUCTURA_TERRITORIAL_DISTRITOParam xWhere);
