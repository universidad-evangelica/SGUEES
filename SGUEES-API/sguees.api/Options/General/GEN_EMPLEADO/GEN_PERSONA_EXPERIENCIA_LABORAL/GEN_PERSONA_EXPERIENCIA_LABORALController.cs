// Qué hace: endpoints anidados de experiencia laboral (tab Experiencia de gen-empleado).
...
namespace sguees.Controllers
{
	...
	[Route("[controller]")]
	[ApiController]
	public class GEN_PERSONA_EXPERIENCIA_LABORALController : ControllerBase
	{
		private readonly IGEN_PERSONA_EXPERIENCIA_LABORALService _service;

		public GEN_PERSONA_EXPERIENCIA_LABORALController(IGEN_PERSONA_EXPERIENCIA_LABORALService service)
		{
		...
		public async Task<CResult> GetAll([FromQuery] GEN_PERSONA_EXPERIENCIA_LABORALParam Data)
		{
			return await _service.GetAllAsync(Data, GetCorrEmpresa());
		}

		// Qué hace: guarda experiencia laboral (insert/update/delete sync de la lista).
		...
		public async Task<IActionResult> SaveAll(
			[FromQuery] GEN_PERSONA_EXPERIENCIA_LABORALParam filter,
			[FromBody] List<GEN_PERSONA_EXPERIENCIA_LABORALTable> Data)
		{
