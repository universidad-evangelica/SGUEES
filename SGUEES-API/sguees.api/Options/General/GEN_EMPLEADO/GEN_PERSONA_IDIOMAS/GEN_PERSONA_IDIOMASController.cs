// Qué hace: endpoints anidados de idiomas (tab Idiomas de gen-empleado).
...
namespace sguees.Controllers
{
	...
	[Route("[controller]")]
	[ApiController]
	public class GEN_PERSONA_IDIOMASController : ControllerBase
	{
		private readonly IGEN_PERSONA_IDIOMASService _service;

		public GEN_PERSONA_IDIOMASController(IGEN_PERSONA_IDIOMASService service)
		{
		...
		public async Task<CResult> GetAll([FromQuery] GEN_PERSONA_IDIOMASParam Data)
		{
			return await _service.GetAllAsync(Data, GetCorrEmpresa());
		}

		// Qué hace: guarda idiomas (insert/update/delete sync de la lista).
		...
		public async Task<IActionResult> SaveAll(
			[FromQuery] GEN_PERSONA_IDIOMASParam filter,
			[FromBody] List<GEN_PERSONA_IDIOMASTable> Data)
		{
