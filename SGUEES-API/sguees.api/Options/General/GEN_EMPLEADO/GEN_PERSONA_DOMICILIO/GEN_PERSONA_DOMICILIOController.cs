// Qué hace: endpoints anidados de domicilios (tab Direcciones de gen-empleado).
using System;
...
namespace sguees.Controllers
{
	...
	[Route("[controller]")]
	[ApiController]
	public class GEN_PERSONA_DOMICILIOController : ControllerBase
	{
		private readonly IGEN_PERSONA_DOMICILIOService _service;

		public GEN_PERSONA_DOMICILIOController(IGEN_PERSONA_DOMICILIOService service)
		{
		...
		public async Task<CResult> GetAll([FromQuery] GEN_PERSONA_DOMICILIOParam Data)
		{
		...
		public async Task<IActionResult> SaveAll(
			[FromQuery] GEN_PERSONA_DOMICILIOParam filter,
			[FromBody] List<GEN_PERSONA_DOMICILIOTable> Data)
		{
