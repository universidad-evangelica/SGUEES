// Qué hace: endpoints anidados de hijos (tab Familiares de gen-empleado).
...
namespace sguees.Controllers
{
	...
	[Route("[controller]")]
	[ApiController]
	public class GEN_PERSONA_HIJOSController : ControllerBase
	{
		private readonly IGEN_PERSONA_HIJOSService _service;

		public GEN_PERSONA_HIJOSController(IGEN_PERSONA_HIJOSService service)
		{
		...
		public async Task<CResult> GetAll([FromQuery] GEN_PERSONA_HIJOSParam Data)
		{
			return await _service.GetAllAsync(Data, GetCorrEmpresa());
		}

		// Qué hace: guarda hijos (insert/update/delete sync de la lista).
		...
		public async Task<IActionResult> SaveAll(
			[FromQuery] GEN_PERSONA_HIJOSParam filter,
			[FromBody] List<GEN_PERSONA_HIJOSTable> Data)
		{
