// Qué hace: endpoints anidados de competencias (tab Competencias de gen-empleado).
...
namespace sguees.Controllers
{
	...
	[Route("[controller]")]
	[ApiController]
	public class GEN_PERSONA_COMPETENCIAController : ControllerBase
	{
		private readonly IGEN_PERSONA_COMPETENCIAService _service;

		public GEN_PERSONA_COMPETENCIAController(IGEN_PERSONA_COMPETENCIAService service)
		{
		...
		public async Task<CResult> GetAll([FromQuery] GEN_PERSONA_COMPETENCIAParam Data)
		{
			return await _service.GetAllAsync(Data, GetCorrEmpresa());
		}

		// Qué hace: guarda competencias (insert/update/delete sync de la lista).
		...
		public async Task<IActionResult> SaveAll(
			[FromQuery] GEN_PERSONA_COMPETENCIAParam filter,
			[FromBody] List<GEN_PERSONA_COMPETENCIATable> Data)
		{
