// Qué hace: endpoints anidados de familiares (tab Familiares de gen-empleado).
...
namespace sguees.Controllers
{
	...
	[Route("[controller]")]
	[ApiController]
	public class GEN_PERSONA_FAMILIARController : ControllerBase
	{
		private readonly IGEN_PERSONA_FAMILIARService _service;

		public GEN_PERSONA_FAMILIARController(IGEN_PERSONA_FAMILIARService service)
		{
		...
		public async Task<CResult> GetAll([FromQuery] GEN_PERSONA_FAMILIARParam Data)
		{
			return await _service.GetAllAsync(Data, GetCorrEmpresa());
		}

		// Qué hace: guarda familiares (insert/update/delete sync de la lista).
		...
		public async Task<IActionResult> SaveAll(
			[FromQuery] GEN_PERSONA_FAMILIARParam filter,
			[FromBody] List<GEN_PERSONA_FAMILIARTable> Data)
		{
