// Qué hace: contrato del servicio de familiares (tab Familiares de empleado).
...
{
	public interface IGEN_PERSONA_FAMILIARService
	{
		Task<CResult> GetAllAsync(GEN_PERSONA_FAMILIARParam xWhere, int corrEmpresa);
