// Qué hace: endpoints anidados de referencias laborales (tab gen-empleado).
...
namespace sguees.Controllers
{
	...
	[Route("[controller]")]
	[ApiController]
	public class GEN_PERSONA_REFERENCIA_LABORALController : ControllerBase
	{
		private readonly IGEN_PERSONA_REFERENCIA_LABORALService _service;

		public GEN_PERSONA_REFERENCIA_LABORALController(IGEN_PERSONA_REFERENCIA_LABORALService service)
		{
		...
		public async Task<CResult> GetAll([FromQuery] GEN_PERSONA_REFERENCIA_LABORALParam Data)
		{
		...
		public async Task<IActionResult> SaveAll(
			[FromQuery] GEN_PERSONA_REFERENCIA_LABORALParam filter,
			[FromBody] List<GEN_PERSONA_REFERENCIA_LABORALTable> Data)
		{
