// Qué hace: endpoints anidados de contactos (tab Contactos de gen-empleado).
// Cómo lo hace: GetAll merge; Put SaveAll con lista Table + CORR_PERSONA en query.
using System;
...
namespace sguees.Controllers
{
	...
	[Route("[controller]")]
	[ApiController]
	public class GEN_PERSONA_CONTACTOController : ControllerBase
	{
		private readonly IGEN_PERSONA_CONTACTOService _service;

		public GEN_PERSONA_CONTACTOController(IGEN_PERSONA_CONTACTOService service)
		{
		...
		public async Task<CResult> GetAll([FromQuery] GEN_PERSONA_CONTACTOParam Data)
		{
			return await _service.GetAllAsync(Data, GetCorrEmpresa());
		}

		// Qué hace: guarda contactos (insert/update/delete vacío).
		...
		public async Task<IActionResult> SaveAll(
			[FromQuery] GEN_PERSONA_CONTACTOParam filter,
			[FromBody] List<GEN_PERSONA_CONTACTOTable> Data)
		{
