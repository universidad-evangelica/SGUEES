...
{
	public class GEN_TIPO_DOCUMENTO_RUBRORepository: BaseRepository<GEN_TIPO_DOCUMENTO_RUBROTable>, IGEN_TIPO_DOCUMENTO_RUBRORepository
	{
		private const string _TableName = "GEN_TIPO_DOCUMENTO_RUBRO";
		
		public GEN_TIPO_DOCUMENTO_RUBRORepository(IConfiguration config) : 
		...
		public async Task<CResult> GetAllAsync(List<CParameter> xWhere)
		{
			...
			try
			{
				var reader = await objData.GetDataReader("V_"+_TableName, xWhere, "ORDEN_TOTAL");
		...
		public async Task<CResult> GetAsync(List<CParameter> xWhere)
		{
			...
			try
			{
				...
				var response = new List<GEN_TIPO_DOCUMENTO_RUBROView>().FromDataReader(reader).FirstOrDefault();
